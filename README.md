...
+ [`2.9.1`,`latest` (2.9.1/Dockerfile)](https://github.com/opinioapp/ember-cli/blob/2.9.1/Dockerfile)
...
ember-cli v2.9.1 + node 6.9.1 + npm 3.10.8 + bower 1.8.0 + phantomjs-prebuilt 2.1.13 + watchman 3.5.0
...
3. Start the ember server:
   ...
   ```
   $ docker run --rm --privileged --entrypoint sysctl opinioapp/ember-cli:2.9.1 -w fs.inotify.max_user_watches=524288
   ```
