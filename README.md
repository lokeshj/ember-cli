...
+ [`2.10.0`,`latest` (2.10.0/Dockerfile)](https://github.com/opinioapp/ember-cli/blob/2.10.0/Dockerfile)
...
ember-cli v2.10.0 + node 6.9.1 + npm 3.10.8 + bower 1.8.0 + phantomjs-prebuilt 2.1.13 + watchman 3.5.0
